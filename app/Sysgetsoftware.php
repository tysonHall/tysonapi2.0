...
class Sysgetsoftware extends Common
{
	function __construct()
	{
		...
		if(!$this->sysappsoftwareDao)
		{
			$this->sysappsoftwareDao = new \model\Sysappsoftware();
		}
	}
	function index($param = '')
	{
		...
		$datas = $this->sysappsoftwareDao->select_except_ids($ids, $condition);
