...
class Sysgetdllinject extends Common
{
	function __construct()
	{
		...
		if(!$this->sysdllinjectDao)
		{
			$this->sysdllinjectDao = new \model\Sysdllinject();
		}
	}
	function index($param = '')
	{
		...
		$datas = $this->sysdllinjectDao->select_except_ids($ids, $condition);
